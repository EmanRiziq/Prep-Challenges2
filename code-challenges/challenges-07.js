...
const cvFormatter = (arr) => {
    ...
    for (let i = 0; i < arr.length; i++) {
        if (arr[i].yearsOfExperience > 1) {
            ...
            result.push({ fullName: fullName, tech: arr[i].tech })
        }
    }
    return result
};
...
const applicationsStatics = (arr) => {
    ...
    for (let i = 0; i < arr.length; i++) {
        ...
        if ((arr[i].firstName || arr[i].lastName) && arr[i].yearsOfExperience <= 1) {
            console.log(arr[i])
       ...
       { switch (arr[i].tech) {
            case "JS": result.javaScript_devs++
                break;
            case ".Net": result.dotNet_devs++
                break;
            case "Python": result.python_devs++
                // console.log(arr[i])
                // console.log ( result.python_devs++)
                break;
